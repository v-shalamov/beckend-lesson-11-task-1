package de.aittr.g_27_shop_demo.repositories;


import de.aittr.g_27_shop_demo.domain.Dog;
import de.aittr.g_27_shop_demo.domain.SimpleDog;
...
public class DogRepository implements CrudRepository<Dog> {
    ...
    public Dog save(Dog obj) {
        try (Connection connection = getConnection()) {
            ...
            String query = String.format(Locale.US, "INSERT INTO dog (age, color, weight) VALUES (%d, '%s', %.2f)",
                obj.getAge(), obj.getColor(), obj.getWeight());
